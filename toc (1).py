...
def creating_final_editable_pdf(input_path,output_path,input_file):
    os.chdir(input_path)
...
creating_table_of_contents(input_path,input_file)
creating_final_editable_pdf(input_path,output_path,input_file)